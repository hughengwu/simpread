      ...
      if ( isProduction() ) {
        ...
        plugins.push(
          new CopyWebpackPlugin([
            ...
            { from   : "src/sw.js" ,                      to : '../' },
            { from   : "src/framescript.js" ,             to : '../' },
            { from   : "src/offscreen/speech.html" ,      to : '../offscreen/' },
            { from   : "src/offscreen/speech.js" ,        to : '../offscreen/' },
    ...
    config = {
      ...
      resolve: {
        alias : {
          ...
          iframe     : __dirname + '/src/service/iframe.js',
          selector   : __dirname + '/src/service/selector.js',
          obsidian   : __dirname + '/src/service/obsidian.js',
          edgetts    : __dirname + '/src/service/edgetts.js',
          speech     : __dirname + '/src/service/speech.js',
          ...
          speechopt  : __dirname + '/src/module/speech.jsx',
